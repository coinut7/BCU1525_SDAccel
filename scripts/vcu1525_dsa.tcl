...
set_property dsa.name {sqrl_bcu1525} [current_project]
set_property dsa.vendor "sqrl.com" [current_project]
set_property dsa.board_id "bcu1525" [current_project]
...
write_dsa sqrl_bcu1525_xdma_2019_1.dsa -include_bit -include_emulation -legacy -force
